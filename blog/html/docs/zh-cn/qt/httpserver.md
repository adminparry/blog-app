...
void HttpServer::addHttpServer(QString type,QString path,QString ContentType,std::function<QString(QString)>fun){
    this->ServerList.append(new ServerAuth(path,type,ContentType,fun));
}
...
QByteArray HttpServer::handleIco(){
    QFile file(IcoPath);
